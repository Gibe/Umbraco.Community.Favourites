...
import type UmbracoFavouritesPinWorkspaceAction from "./workspaceaction.action.js";
...
@customElement("umbraco-favourites-pin-workspace-action")
export default class UmbracoFavouritesPinWorkspaceActionElement extends UmbElementMixin(LitElement) {

  // Umbraco automatically passes the initialized API class into this property
  @property({ attribute: false })
  public api?: UmbracoFavouritesPinWorkspaceAction;
  ...
  connectedCallback() {
    ...
    window.addEventListener("umbraco-favourites-updated", this.#onFavouritesUpdated);
  }

  disconnectedCallback() {
    window.removeEventListener("umbraco-favourites-updated", this.#onFavouritesUpdated);
