import { LitElement as h, html as n, css as m, state as d, customElement as _ } from "@umbraco-cms/backoffice/external/lit";
...
let o = class extends p(h) {
  ...
  connectedCallback() {
    super.connectedCallback(), this._loadFavourites(), window.addEventListener("umbraco-favourites-updated", this._boundRefresh), this.consumeContext(f, (e) => {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), window.removeEventListener("umbraco-favourites-updated", this._boundRefresh), this._actionEventContext?.removeEventListener(
      v.TYPE,
      this._boundRefresh
    );
  }
  ...
  async _removeFavourite(e, t) {
    ...
    }), this._loadFavourites(), window.dispatchEvent(new CustomEvent("umbraco-favourites-updated"));
  }
  _onDragStart(e, t) {
...
//# sourceMappingURL=pins.element-CMxWk5Q0.js.map
