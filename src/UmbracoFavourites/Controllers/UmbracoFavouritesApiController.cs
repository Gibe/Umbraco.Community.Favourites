...
public class UmbracoFavouritesApiController : UmbracoFavouritesApiControllerBase
{
    private readonly IUmbracoFavouritesRepository _favouritesRepository;
    private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;
    private readonly IContentService _contentService;

    public UmbracoFavouritesApiController(
        IUmbracoFavouritesRepository favouritesRepository,
