...
namespace UmbracoFavourites.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "UmbracoFavourites")]
    public class UmbracoFavouritesDebugApiController : UmbracoFavouritesApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoFavouritesDebugApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
