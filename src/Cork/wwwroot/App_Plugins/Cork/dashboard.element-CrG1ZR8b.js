import { LitElement as w, html as y, css as x, state as h, customElement as C } from "@umbraco-cms/backoffice/external/lit";
...
class d {
  ...
  static whatsMyName(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/cork/api/v1/whatsMyName",
      ...e
    });
  }
  static whatsTheTimeMrWolf(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/cork/api/v1/whatsTheTimeMrWolf",
      ...e
    });
  }
  static whoAmI(e) {
    return (e?.client ?? c).get({
      ...
      url: "/umbraco/cork/api/v1/whoAmI",
      ...e
    });
  }
}
var U = Object.defineProperty, k = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var s = a > 1 ? void 0 : a ? k(e, r) : e, m = t.length - 1, p; m >= 0; m--)
    (p = t[m]) && (s = (a ? p(e, r, s) : p(s)) || s);
  return a && s && U(e, r, s), s;
}, g = (t, e, r) => e.has(t) || b("Cannot " + r), o = (t, e, r) => (g(t, e, "read from private field"), r ? r.call(t) : e.get(t)), l = (t, e, r) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), E = (t, e, r, a) => (g(t, e, "write to private field"), e.set(t, r), r), n, f, v, _;
...
//# sourceMappingURL=dashboard.element-CrG1ZR8b.js.map
