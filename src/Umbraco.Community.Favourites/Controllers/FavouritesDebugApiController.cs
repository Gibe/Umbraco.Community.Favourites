...
namespace Favourites.Controllers
{
    ...
    public class FavouritesDebugApiController : FavouritesApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public FavouritesDebugApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
