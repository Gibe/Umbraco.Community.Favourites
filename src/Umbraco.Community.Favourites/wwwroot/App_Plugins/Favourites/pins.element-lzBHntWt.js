...
let o = class extends m(h) {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), window.removeEventListener("favourites-updated", this._boundRefresh), this._actionEventContext?.removeEventListener(
      v.TYPE,
      this._boundRefresh
    );
  }
